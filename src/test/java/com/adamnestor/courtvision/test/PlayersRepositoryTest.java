...
public class PlayersRepositoryTest extends BaseTestSetup {
    ...
    @Test
    void testFindPlayersWithStats() {
        List<Players> players = playersRepository.findPlayersWithStats(PlayerStatus.ACTIVE);
        ...
        assertThat(players)
                ...
                .allSatisfy(player -> {
                    ...
                    // Verify this player has associated game stats
                    assertThat(gameStatsRepository.findByPlayer(player)).isNotEmpty();
                });
    }

    @Test
    void testFindActivePlayersByTeam() {
        List<Players> players = playersRepository.findActivePlayersByTeam(
                testTeam,
                PlayerStatus.ACTIVE
        );
